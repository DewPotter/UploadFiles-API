...
/****** Object:  Database [UploadFiles]    Script Date: 10/7/2024 5:33:56 AM ******/
CREATE DATABASE [UploadFiles]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'UploadFiles', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\UploadFiles.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'UploadFiles_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\UploadFiles_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [UploadFiles] SET RECOVERY SIMPLE 
GO
